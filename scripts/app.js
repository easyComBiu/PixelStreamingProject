...
function setupHtmlEvents() {
    ...
    git remote add origin https://github.com//easyComBiu/PixelStreamingProject.git
...
let styleAdditional;
// styleAdditional 全局变量中设置自定义CSS值。每当 app.js 调整播放器大小并清除其样式时，
// 它会将 styleAdditional 变量中设置的值附加到它分配给播放器元素的新样式属性的末尾。
// 举例而言，用户将鼠标悬停在播放器控件上时，以下数值会将鼠标光标变为一只手：
// let styleAdditional = 'cursor: grab; cursor: -moz-grab; cursor: -webkit-grab';
